            ...
            for (var i = 0; i < half_imgLen; i++) {
                ...
                if(k == 0){
                    this.$aImg.eq(leftNum).css({
                        ...
                        // transform: 'translateX('+(-200 * (i + 1))+'px) translateZ(-120px) rotateY(0)'
                        transform: 'translateX(-600px) translateZ(-120px) rotateY(0)'
                    }).animate({
                    ...
                    this.$aImg.eq(leftNum).css({
                        ...
                        transform: 'translateX(0px) translateZ(-1000px) rotateY(0)',
                        opacity: '0'
                        // display:'none'
                    });
